 ...
 *	导出
 */
public class AggPatientMasterVOExcelOutputProcessor extends AbstractExcelOutputProcessor {
	...
	public Object[] getObjectValueByPks(String[] pks) throws BusinessException {
		...
		AggPatientMasterVO[] queryResult = getService().listAggPatientMasterVOByPk(pks);
	...
	class DefRefPropertyProcess implements IRefPropertyProcess{
		...
		public AbstractRefModel getRefModelByProperty(FormPropertyVO property) {
			...
			// 1、判断是否有树形上级参照自身字段
			if("bdca937a-c341-4485-a9f5-1377af31f057".equals(classid) && pid != null && pid.equals(property.getCode())) {
