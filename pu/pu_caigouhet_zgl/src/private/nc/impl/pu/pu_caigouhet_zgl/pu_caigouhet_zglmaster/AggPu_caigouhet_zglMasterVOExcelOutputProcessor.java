 ...
 *	导出
 */
public class AggPu_caigouhet_zglMasterVOExcelOutputProcessor extends AbstractExcelOutputProcessor {
	...
	public Object[] getObjectValueByPks(String[] pks) throws BusinessException {
		...
		AggPu_caigouhet_zglMasterVO[] queryResult = getService().listAggPu_caigouhet_zglMasterVOByPk(pks);
	...
	class DefRefPropertyProcess implements IRefPropertyProcess{
		...
		public AbstractRefModel getRefModelByProperty(FormPropertyVO property) {
			...
			// 1、判断是否有树形上级参照自身字段
			if("07ac49c2-37f2-4f97-b4c9-ed397e9ca9f0".equals(classid) && pid != null && pid.equals(property.getCode())) {
