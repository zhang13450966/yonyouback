package nc.vo.pu.region_cjm;

import nc.vo.pub.*;
import nc.vo.pubapp.pattern.model.meta.entity.vo.VOMetaFactory;

public class Region_CjmMasterVO extends SuperVO {

	//构造方法
	public Region_CjmMasterVO() {
		super();
	}
    ...
    private java.lang.String pk_region_cjmmaster  ;
	...
	public static final String PK_REGION_CJMMASTER = "pk_region_cjmmaster";
	...
	public void setPk_region_cjmmaster(java.lang.String pk_region_cjmmaster){
		this.pk_region_cjmmaster = pk_region_cjmmaster;
	}

	public java.lang.String getPk_region_cjmmaster(){
		return this.pk_region_cjmmaster;
	} 
	...
	@Override
	@nc.vo.annotation.MDEntityInfo(beanFullclassName =  "nc.vo.pu.region_cjm.Region_CjmMasterVO" )
	public IVOMeta getMetaData() {
		return VOMetaFactory.getInstance().getVOMeta("pu.region_CjmMaster");
  	}
