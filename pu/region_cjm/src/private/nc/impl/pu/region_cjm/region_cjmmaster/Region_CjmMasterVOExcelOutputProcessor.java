 ...
 *	导出
 */
public class Region_CjmMasterVOExcelOutputProcessor extends AbstractExcelOutputProcessor {
	...
	public Object[] getObjectValueByPks(String[] pks) throws BusinessException {
		...
		Region_CjmMasterVO[] queryResult = getService().listRegion_CjmMasterVOByPk(pks, false);
	...
	class DefRefPropertyProcess implements IRefPropertyProcess{
		...
		public AbstractRefModel getRefModelByProperty(FormPropertyVO property) {
			...
			// 1、判断是否有树形上级参照自身字段
			if("022592a0-da5e-42b2-b9bc-d9ed490c18d2".equals(classid) && pid != null && pid.equals(property.getCode())) {
