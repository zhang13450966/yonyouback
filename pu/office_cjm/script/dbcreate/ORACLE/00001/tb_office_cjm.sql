 create table PU_OFFICE_CJMMASTER (def20 varchar2(101) null /*自定义项20*/,
...
pid varchar2(20) null /*大区*/,
pk_office_cjmmaster char(20) not null /*主键*/,
ts char(19) default to_char(sysdate,'yyyy-mm-dd hh24:mi:ss') null /*null*/,
dr integer null /*null*/,
 constraint PU_OFFICE_CJMMASTER_PK  primary key (pk_office_cjmmaster)
)
