 ...
 *	导出
 */
public class Office_CjmMasterVOExcelOutputProcessor extends AbstractExcelOutputProcessor {
	...
	public Object[] getObjectValueByPks(String[] pks) throws BusinessException {
		...
		Office_CjmMasterVO[] queryResult = getService().listOffice_CjmMasterVOByPk(pks, false);
	...
	class DefRefPropertyProcess implements IRefPropertyProcess{
		...
		public AbstractRefModel getRefModelByProperty(FormPropertyVO property) {
			...
			// 1、判断是否有树形上级参照自身字段
			if("0ed5d233-a42f-4897-b4ad-b60fa8cd3f06".equals(classid) && pid != null && pid.equals(property.getCode())) {
