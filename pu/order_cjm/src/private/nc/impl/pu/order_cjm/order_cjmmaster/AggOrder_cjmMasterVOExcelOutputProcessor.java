 ...
 *	导出
 */
public class AggOrder_cjmMasterVOExcelOutputProcessor extends AbstractExcelOutputProcessor {
	...
	public Object[] getObjectValueByPks(String[] pks) throws BusinessException {
		...
		AggOrder_cjmMasterVO[] queryResult = getService().listAggOrder_cjmMasterVOByPk(pks);
	...
	class DefRefPropertyProcess implements IRefPropertyProcess{
		...
		public AbstractRefModel getRefModelByProperty(FormPropertyVO property) {
			...
			// 1、判断是否有树形上级参照自身字段
			if("b357e32e-7d0c-437c-95ea-18358ee8ea4c".equals(classid) && pid != null && pid.equals(property.getCode())) {
